	...
	public class OpenWorldLocations
	{
		...
		public static List<Location> getAllLocations()
		{
			var list = new List<Location>
			{
				...
				new Location
				{
						name = "shade palace glove orb chest",
				...
				new Location
				{
						name = "sunken continent sword orb chest",
						internal_name = "sunken continent sword orb chest",
				},


				new Location
				{
						name = "lumina tower axe orb chest",
						internal_name = "lumina tower axe orb chest",
				},


				new Location
				{
						name = "fire palace axe orb chest",
						internal_name = "fire palace axe orb chest",
				},


				new Location
				{
						name = "lumina tower spear orb chest",
						internal_name = "lumina tower spear orb chest",
				},


				new Location
				{
						name = "sunken continent boomerang orb chest",
						internal_name = "sunken continent boomerang orb chest",
				},


				new Location
				{
						name = "fire palace chest 1",
						internal_name = "fire palace chest 1",
				},


				new Location
				{
						name = "fire palace chest 2",
						internal_name = "fire palace chest 2",
				},
				...
				{
						name = "shade seed",
						internal_name = "shade seed",
				},


				new Location
				{
						name = "thunder gigas (new item)",
						internal_name = "thunder gigas (new item)",
				},


				new Location
				{
						name = "red dragon (new item)",
						internal_name = "red dragon (new item)",
				},


				new Location
				{
						name = "blue dragon (new item)",
						internal_name = "blue dragon (new item)",
				},


				new Location
				{
						name = "mana tree (new item)",
						internal_name = "mana tree (new item)",
				},


				new Location
				{
						name = "matango flammie",
						internal_name = "matango flammie",
				},
				...
				{
						name = "hydra (new item)",
						internal_name = "hydra (new item)",
				},


				new Location
				{
						name = "kettlekin (new item)",
						internal_name = "kettlekin (new item)",
				},


				new Location
				{
						name = "shade palace chest",
						internal_name = "shade palace chest",
				},


				new Location
				{
						name = "luka item 1 (spear)",
						internal_name = "luka item 1 (spear)",
				},


				new Location
				{
						name = "luka item 2 (undine seed)",
						internal_name = "luka item 2 (undine seed)",
				},


				new Location
				{
						name = "sylphid item 1 (spells)",
						internal_name = "sylphid item 1 (spells)",
				},


				new Location
				{
						name = "sylphid item 2 (seed)",
						internal_name = "sylphid item 2 (seed)",
				},
				...
				{
						name = "whip chest",
						internal_name = "whip chest",
				},


				new Location
				{
						name = "moogle village glove orb chest",
						internal_name = "moogle village glove orb chest",
				},


				new Location
				{
						name = "ice castle glove orb chest",
						internal_name = "ice castle glove orb chest",
				},


				new Location
				{
						name = "pandora sword orb chest",
						internal_name = "pandora sword orb chest",
				},


				new Location
				{
						name = "northtown ruins sword orb chest",
						internal_name = "northtown ruins sword orb chest",
				},


				new Location
				{
						name = "moogle village axe orb chest",
						internal_name = "moogle village axe orb chest",
				},


				new Location
				{
						name = "northtown castle axe orb chest",
						internal_name = "northtown castle axe orb chest",
				},


				new Location
				{
						name = "northtown ruins spear orb chest",
						internal_name = "northtown ruins spear orb chest",
				},


				new Location
				{
						name = "pandora spear orb chest",
						internal_name = "pandora spear orb chest",
				},


				new Location
				{
						name = "santa spear orb chest",
						internal_name = "santa spear orb chest",
				},


				new Location
				{
						name = "kilroy whip orb chest",
						internal_name = "kilroy whip orb chest",
				},


				new Location
				{
						name = "northtown castle whip orb chest",
						internal_name = "northtown castle whip orb chest",
				},


				new Location
				{
						name = "northtown ruins bow orb chest",
						internal_name = "northtown ruins bow orb chest",
				},
				...
				{
						name = "potos chest",
						internal_name = "potos chest",
				},


				new Location
				{
						name = "pandora chest 1",
						internal_name = "pandora chest 1",
				},


				new Location
				{
						name = "pandora chest 2",
						internal_name = "pandora chest 2",
				},


				new Location
				{
						name = "pandora chest 3",
						internal_name = "pandora chest 3",
				},


				new Location
				{
						name = "pandora chest 4",
						internal_name = "pandora chest 4",
				},


				new Location
				{
						name = "magic rope chest",
						internal_name = "magic rope chest",
				},


				new Location
				{
						name = "northtown castle chest",
						internal_name = "northtown castle chest",
				},


				new Location
				{
						name = "matango inn javelin orb chest",
						internal_name = "matango inn javelin orb chest",
				},
				...
				{
						name = "watts (axe)",
						internal_name = "watts (axe)",
				},


				new Location
				{
						name = "undine item 1 (spells)",
						internal_name = "undine item 1 (spells)",
				},


				new Location
				{
						name = "undine item 2 (javelin)",
						internal_name = "undine item 2 (javelin)",
				},
				...
				{
						name = "mara (tower key)",
						internal_name = "mara (tower key)",
				},


				new Location
				{
						name = "turtle island (sea hare tail)",
						internal_name = "turtle island (sea hare tail)",
				},


				new Location
				{
						name = "dwarf elder (midge mallet)",
						internal_name = "dwarf elder (midge mallet)",
				},


				new Location
				{
						name = "tropicallo (sprite)",
						internal_name = "tropicallo (sprite)",
				},
				...
				new Location
				{
						name = "starter weapon (main)",
						internal_name = "starter weapon (main)",
				},


				new Location
				{
						name = "lighthouse (new item)",
						internal_name = "lighthouse (new item)",
				},


				new Location
				{
						name = "kilroy (new item)",
						internal_name = "kilroy (new item)",
				},


				new Location
				{
						name = "mantis ant (new item)",
						internal_name = "mantis ant (new item)",
				},


				new Location
				{
						name = "axe beak (new item)",
						internal_name = "axe beak (new item)",
				},


				new Location
				{
						name = "snow dragon (new item)",
						internal_name = "snow dragon (new item)",
				},


				new Location
				{
						name = "dragon worm (new item)",
						internal_name = "dragon worm (new item)",
				},
				...
				{
						name = "mech rider 2",
						internal_name = "mech rider 2",
				},


				new Location
				{
						name = "watermelon (new item)",
						internal_name = "watermelon (new item)",
				},
				...
				{
						name = "hexas (new item)",
						internal_name = "hexas (new item)",
				},


				new Location
				{
						name = "wall face (new item)",
						internal_name = "wall face (new item)",
				},
				new Location
				{
						name = "metal mantis (new item)",
						internal_name = "metal mantis (new item)",
				},
				new Location
				{
						name = "jema at tasnica",
						internal_name = "jema at tasnica",
				},
				new Location
				{
						name = "triple tonpole",
						internal_name = "triple tonpole",
				},
			};
			const long baseId = 0;
